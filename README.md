...
This template uses the [authentication SDK](https://web3sdk.io/authentication)
along with Discord OAuth to grant users who own an NFT from a specific collection a special role
in a Discord server.

## Tools:

- [**React SDK**](https://docs.web3sdk.io/react): To connect to the user's MetaMask wallet.

- [**TypeScript SDK**](https://docs.web3sdk.io/typescript): To view the balance of the connected wallet in an NFT collection.

- [**Authentication SDK**](https://web3sdk.io/authentication) to allow the user to sign in with Ethereum and verify they own their wallet.
...
### web3sdkio and NextAuth Wrappers
